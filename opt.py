...
parser.add_argument('--expID', default='default', type=str,
                    help='Experiment ID')
parser.add_argument('--dataset', default='THuman2.0', type=str,
...
parser.add_argument('--freq_gallery', type=int, default=7000, help='freqency of the error plot')

"----------------------------- PIFu configs -----------------------------"
parser.add_argument('--config', default='./configs/MHPIFu_UNet_THuman.py', type=str, help='train config file path')
